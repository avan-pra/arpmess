...
\t"ANSI_COLOR_BRIGHT_YELLOW"["ANSI_COLOR_BRIGHT_RED"4"ANSI_COLOR_BRIGHT_YELLOW"]"ANSI_COLOR_RESET" "ANSI_COLOR_BRIGHT_WHITE"Arpspoof"ANSI_COLOR_RESET"\n\
\n\
